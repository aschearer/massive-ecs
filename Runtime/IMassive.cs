namespace Massive
{
    ...
    public interface IMassive
    {
        ...
        /// A value of 0 restores data to the state of the last <see cref="SaveFrame"/> call.
        /// </summary>
        /// <param name="frames">
        /// The number of frames to roll back. Must be non-negative and not exceed <see cref="CanRollbackFrames"/>.
        /// </param>
