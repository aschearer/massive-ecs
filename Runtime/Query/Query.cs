...
namespace Massive
{
    ...
    public struct Query : IQueryable
    {
        ...
        readonly Query IQueryable.Query => this;

        public EntityEnumerable Entities => new(RentCacheAndPrepare(), World);
        ...
        private readonly void ApplyFilter(Filter filter, QueryCache resultQueryCache)
        {
