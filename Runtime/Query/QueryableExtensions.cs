...
namespace Massive
{
    ...
    public static class QueryableExtensions
    {
        ...
        public static void ForEach<TQueryable, TArgs, T1, T2, T3, T4, T5, T6>(this TQueryable queryable, TArgs args, EntityActionRefArgs<T1, T2, T3, T4, T5, T6, TArgs> action)
            where TQueryable : IQueryable
        {
            var entityActionRefArgsAdapter = new EntityActionRefArgsAdapter<T1, T2, T3, T4, T5, T6, TArgs> { Action = action, Entities = queryable.World.Entities, Entity = new Entity(Entifier.Dead, queryable.World), Args = args };
