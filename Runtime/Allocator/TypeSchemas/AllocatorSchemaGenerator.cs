...
namespace Massive
{
    ...
    {
        private static readonly List<AllocatorDataSchema> _schemas = new();
        private static readonly Dictionary<Type, byte> _schemaIndices = new();
        private static readonly Dictionary<AllocatorDataSchema, byte> _existingSchemas = new();
